...
%include "./include/stdio.inc"			; basic i/o routines
%include "./include/GDT.inc"			; Gdt routines
%include "./include/A20.inc"			; Gdt routines
%include "./include/Fat12.inc"			; FAT12 driver. Kinda :)
...
Welcome32msg db "Welcome to 32 bit Operating System", 0x0D, 0x0A, 0x00
